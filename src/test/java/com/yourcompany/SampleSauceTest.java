...
public class SampleSauceTest {
    ...
    public static Object[][] sauceBrowserDataProvider(Method testMethod) {
        return new Object[][]{
                // Devices
                new Object[]{"device","Chrome", "latest", "Android","Samsung.*"},
                new Object[]{"device","Safari", "latest", "iOS", "iPhone.*"},
                new Object[]{"device","Edge", "latest", "Android","Samsung.*"},
                new Object[]{"device","Firefox", "latest", "iOS", "iPhone.*"},
        };
    }
